...
<div class="max-w-4xl mx-auto">
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
        <div class="p-6 border-b border-gray-100 dark:border-gray-700">
            ...
            <p class="text-gray-500 dark:text-gray-400 mt-1">Isi formulir berikut untuk menambahkan kelas baru</p>
        </div>
        ...
        <form action="{{ route('classes.store') }}" method="POST" class="p-6 space-y-6">
            ...
            <div>
                ...
                <textarea name="description" rows="3" 
                    ...
                    class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white">{{ old('description') }}</textarea>
            </div>
